        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CargoOwners_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClearanceAgents_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgentSpecializations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AgentSpecializations_ClearanceAgents_AgentId",
                        column: x => x.AgentId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DestinationPort = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Requests_CargoOwners_CargoOwnerId",
                        column: x => x.CargoOwnerId,
                        principalTable: "CargoOwners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requests_ClearanceAgents_AgentId",
                        column: x => x.AgentId,
                        principalTable: "ClearanceAgents",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ratings_ClearanceAgents_AgentId",
                        column: x => x.AgentId,
                        principalTable: "ClearanceAgents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgentSpecializations_AgentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClearanceAgents_LicenseNumber",
                table: "ClearanceAgents",
                column: "LicenseNumber");

            migrationBuilder.CreateIndex(
                name: "IX_ClearanceAgents_UserId",
                table: "ClearanceAgents",
                column: "UserId",
                unique: true);
